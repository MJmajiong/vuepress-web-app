          ...
          [
            function() {
              var t = this.$createElement,
                e = this._self._c || t
              return e('p', [
                e('img', { attrs: { src: 'https://image.nicelinks.site/quickapp.png', alt: '快应用开发体验纪要' } })
              ])
            },
            function() {
              var t = this.$createElement,
                e = this._self._c || t
              return e('h3', { attrs: { id: '🎉-本文目录-🎉' } }, [
                e('a', { staticClass: 'header-anchor', attrs: { href: '#🎉-本文目录-🎉', 'aria-hidden': 'true' } }, [
                  this._v('#')
                ]),
                this._v(' 🎉 本文目录 🎉')
              ])
            ...
            function() {
              var t = this,
                e = t.$createElement,
                r = t._self._c || e
              return r('div', { staticClass: 'table-of-contents' }, [
                r('ul', [
                  r('li', [r('a', { attrs: { href: '#快应用特点' } }, [t._v('快应用特点')])]),
                  r('li', [r('a', { attrs: { href: '#与小程序对比' } }, [t._v('与小程序对比')])]),
                  r('li', [r('a', { attrs: { href: '#开发-调试' } }, [t._v('开发 & 调试')])]),
                  r('li', [r('a', { attrs: { href: '#快应用示例' } }, [t._v('快应用示例')])]),
                  r('li', [r('a', { attrs: { href: '#关于快应用の发布' } }, [t._v('关于快应用の发布')])]),
                  r('li', [r('a', { attrs: { href: '#快应用存在的缺陷' } }, [t._v('快应用存在的缺陷')])]),
                  r('li', [r('a', { attrs: { href: '#如何看待「快应用」' } }, [t._v('如何看待「快应用」?')])]),
                  r('li', [r('a', { attrs: { href: '#同类型文章' } }, [t._v('同类型文章')])])
                ])
              ])
            },
            function() {
              var t = this.$createElement,
                e = this._self._c || t
              return e('p', [
                e('img', { attrs: { src: 'https://image.nicelinks.site/quickapp-red.svg', alt: '快应用 即点即用' } })
              ])
            },
            function() {
              var t = this.$createElement,
                e = this._self._c || t
              return e('h2', { attrs: { id: '快应用特点' } }, [
                e('a', { staticClass: 'header-anchor', attrs: { href: '#快应用特点', 'aria-hidden': 'true' } }, [
                  this._v('#')
                ]),
                this._v(' 快应用特点')
              ])
            ...
            function() {
              var t = this.$createElement,
                e = this._self._c || t
              return e('h2', { attrs: { id: '与小程序对比' } }, [
                e('a', { staticClass: 'header-anchor', attrs: { href: '#与小程序对比', 'aria-hidden': 'true' } }, [
                  this._v('#')
                ]),
                this._v(' 与小程序对比')
              ])
            ...
            function() {
              ...
              return e('p', [
                ...
                e('code', [this._v('Android')]),
                this._v(' 用户带来更多的便捷。同时作为后起之秀，其开发体验上，是明显优于'),
                e('code', [this._v('小程序')]),
                this._v(
            ...
            function() {
              var t = this.$createElement,
                e = this._self._c || t
              return e('h2', { attrs: { id: '开发-调试' } }, [
                e('a', { staticClass: 'header-anchor', attrs: { href: '#开发-调试', 'aria-hidden': 'true' } }, [
                  this._v('#')
                ]),
                this._v(' 开发 & 调试')
              ])
            ...
            function() {
              var t = this.$createElement,
                e = this._self._c || t
              return e('h3', { attrs: { id: '环境搭建' } }, [
                e('a', { staticClass: 'header-anchor', attrs: { href: '#环境搭建', 'aria-hidden': 'true' } }, [
                  this._v('#')
                ]),
                this._v(' 环境搭建')
              ])
            ...
            function() {
              ...
              return e('div', { staticClass: 'language- extra-class' }, [
                e('pre', { pre: !0, attrs: { class: 'language-text' } }, [
                  e('code', [this._v('yarn global add hap-toolkit\n// 检测是否成功安装 hap-toolkit\nhap -V\n')])
                ])
              ])
            },
            function() {
            ...
            function() {
              var t = this.$createElement,
                e = this._self._c || t
              return e('h3', { attrs: { id: '开发环境' } }, [
                e('a', { staticClass: 'header-anchor', attrs: { href: '#开发环境', 'aria-hidden': 'true' } }, [
                  this._v('#')
                ]),
                this._v(' 开发环境')
              ])
            ...
            function() {
              var t = this.$createElement,
                e = this._self._c || t
              return e('h3', { attrs: { id: '开发调试' } }, [
                e('a', { staticClass: 'header-anchor', attrs: { href: '#开发调试', 'aria-hidden': 'true' } }, [
                  this._v('#')
                ]),
                this._v(' 开发调试')
              ])
            ...
            function() {
              ...
              return e('div', { staticClass: 'language- extra-class' }, [
                e('pre', { pre: !0, attrs: { class: 'language-text' } }, [
                  e('code', [this._v('adb logcat -s JsConsole\n')])
                ])
              ])
            },
            function() {
              var t = this.$createElement,
                e = this._self._c || t
              return e('h2', { attrs: { id: '快应用示例' } }, [
                e('a', { staticClass: 'header-anchor', attrs: { href: '#快应用示例', 'aria-hidden': 'true' } }, [
                  this._v('#')
                ]),
                this._v(' 快应用示例')
              ])
            ...
            function() {
              ...
              return e('p', [
                this._v('在安装 '),
                e('code', [this._v('Toolkit')]),
                this._v(' 工具后，可通过全局 '),
                e('code', [this._v('hap')]),
                this._v(' 命令创建一个项目模板，如下所示：')
              ])
            },
            function() {
              var t = this.$createElement,
              ...
              return e('div', { staticClass: 'language- extra-class' }, [
                e('pre', { pre: !0, attrs: { class: 'language-text' } }, [
                  e('code', [this._v('hap init <YourProjectName>\n')])
                ])
              ])
            },
            function() {
            ...
            function() {
              var t = this.$createElement,
                e = this._self._c || t
              return e('li', { staticClass: 'task-list-item' }, [
                e('input', { attrs: { type: 'checkbox', id: 'cbx_11', disabled: 'true' } }),
                e('label', { attrs: { for: 'cbx_11' } }, [this._v(' ... ...')])
              ])
            },
            function() {
              var t = this.$createElement,
                e = this._self._c || t
              return e('h2', { attrs: { id: '关于快应用の发布' } }, [
                e('a', { staticClass: 'header-anchor', attrs: { href: '#关于快应用の发布', 'aria-hidden': 'true' } }, [
                  this._v('#')
                ]),
                this._v(' 关于快应用の发布')
              ])
            ...
            function() {
              var t = this.$createElement,
                e = this._self._c || t
              return e('h2', { attrs: { id: '快应用存在的缺陷' } }, [
                e('a', { staticClass: 'header-anchor', attrs: { href: '#快应用存在的缺陷', 'aria-hidden': 'true' } }, [
                  this._v('#')
                ]),
                this._v(' 快应用存在的缺陷')
              ])
            ...
            function() {
              ...
              return e('p', [
                this._v('从上面'),
                e('a', { attrs: { href: '#%E5%BF%AB%E5%BA%94%E7%94%A8%E7%89%B9%E7%82%B9' } }, [this._v('快应用特点')]),
                this._v(
            ...
            function() {
              ...
              return r('ul', [
                ...
                t._v(' '),
                r('li', [t._v('相比于其他‘竞品’而言，文档、周围生态系统、等都需要亟待完善；长期迭代情况将会好转；')]),
                t._v(' '),
                r('li', [
                  t._v('由国内 '),
                  r('code', [t._v('Android')]),
