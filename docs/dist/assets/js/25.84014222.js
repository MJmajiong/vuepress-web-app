          ...
          [
            ...
            function() {
              var t = this,
                s = t.$createElement,
                a = t._self._c || s
              return a('div', { staticClass: 'language-json extra-class' }, [
            ...
            function() {
              var t = this.$createElement,
                s = this._self._c || t
              return s('h2', { attrs: { id: '默认的低效率写法' } }, [
                s('a', { staticClass: 'header-anchor', attrs: { href: '#默认的低效率写法', 'aria-hidden': 'true' } }, [
                  this._v('#')
                ]),
                this._v(' 默认的低效率写法')
              ])
                ...
                a('pre', { pre: !0, attrs: { class: 'language-js' } }, [
                  a('code', [
                    ...
                    a('span', { pre: !0, attrs: { class: 'token template-string' } }, [
                      a('span', { pre: !0, attrs: { class: 'token template-punctuation string' } }, [t._v('`')]),
                    ...
                    a('span', { pre: !0, attrs: { class: 'token template-string' } }, [
                      a('span', { pre: !0, attrs: { class: 'token template-punctuation string' } }, [t._v('`')]),
                      a('span', { pre: !0, attrs: { class: 'token string' } }, [t._v('fetch handling fail, code = ')]),
                      a('span', { pre: !0, attrs: { class: 'token interpolation' } }, [
                        a('span', { pre: !0, attrs: { class: 'token interpolation-punctuation punctuation' } }, [
                          t._v('${')
                        ]),
            ...
            function() {
              var t = this.$createElement,
                s = this._self._c || t
              return s('p', [
                this._v('以上就是官方文档提供的上古 '),
                s('code', [this._v('jQuery')]),
                this._v(
            ...
            function() {
              var t = this.$createElement,
                s = this._self._c || t
              return s('h2', { attrs: { id: '改进后的用法' } }, [
                s('a', { staticClass: 'header-anchor', attrs: { href: '#改进后的用法', 'aria-hidden': 'true' } }, [
                  this._v('#')
                ]),
                this._v(' '),
                s('strong', [this._v('改进后的用法')])
              ])
            },
            function() {
              var t = this,
            ...
            function() {
              var t = this.$createElement,
                s = this._self._c || t
              return s('h2', { attrs: { id: '优化处理数据请求' } }, [
                s('a', { staticClass: 'header-anchor', attrs: { href: '#优化处理数据请求', 'aria-hidden': 'true' } }, [
                  this._v('#')
                ]),
                this._v(' '),
                s('strong', [this._v('优化处理数据请求')])
              ])
            },
            function() {
              var t = this.$createElement,
              ...
              return s('p', [
                ...
                s('code', [this._v('helpera/ajax.js')]),
                this._v(' 路径下）：')
              ])
            },
            function() {
            ...
            function() {
              var t = this.$createElement,
                s = this._self._c || t
              return s('p', [
                this._v('这 $fetch.fetch 返回本就是一个 '),
                s('code', [this._v('Promise')]),
                this._v(
                ...
                s('code', [this._v('helper/apis/poetry.js')]),
                this._v(' ）：')
              ])
            },
            function() {
            ...
            function() {
              var t = this.$createElement,
                s = this._self._c || t
              return s('h2', { attrs: { id: '更近一步体验优化' } }, [
                s('a', { staticClass: 'header-anchor', attrs: { href: '#更近一步体验优化', 'aria-hidden': 'true' } }, [
                  this._v('#')
                ]),
                this._v(' '),
                s('strong', [this._v('更近一步体验优化')])
              ])
            },
            function() {
              var t = this,
            ...
            function() {
              ...
              return s('blockquote', [
                s('p', [
                  this._v('需要补充说明的是，'),
                  s('code', [this._v('finally')]),
                  this._v(' 方法指定的回调函数，用于指定不管 '),
                  s('strong', [this._v('Promise')]),
                  this._v(
